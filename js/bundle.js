...
function slider(_ref) {
  ...
  var slideIndex = 1;
  var offset = 0; // Функция подстановки ноля к цифрам меньше 10:
...
window.addEventListener('DOMContentLoaded', function () {
  var modalSelector = '.modal',
    ...
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)(modalSelector, modalTimerId);
  }, 5000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_1__.default)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_2__.default)('.form', modalSelector, modalTimerId);
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.default)('[data-modal]', modalSelector, modalTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__.default)('.timer', '2021-03-01');
